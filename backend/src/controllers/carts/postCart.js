const {Cart, Products, Tags, Brand, Category, Subcategory} = require('../../db');

const postCreateProductInCart = async(name, href, category, imageSrc, imageAlt, price, stock, brand, subcategory, rating, description, isActive, tags)=> {
