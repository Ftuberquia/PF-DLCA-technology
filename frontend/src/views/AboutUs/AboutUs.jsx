...
import Andres from "../../img/Team/team-andres.jpg";
        ...
        <>
          <div className={style.bodyContainer}>
            ...
            <p className={style.introParagraph}>
              Somos un equipo de desarrolladores web que trabajamos con el stack
              PERN, (PostgreSQL, Express, React y Node.js). Nuestro objetivo es
              proporcionar a DLCA Technology una plataforma digital que amplíe
              su alcance y mejore su servicio al cliente. Al combinar estas
              tecnologías, podemos crear una aplicación web completa con
              operaciones CRUD. Nuestro equipo ha desarrollado experiencia en la
              construcción de rutas con consultas PostgreSQL y la configuración
              del lado del cliente con React. Como equipo buscamos crear
              soluciones innovadoras y efectivas para nuestro cliente.
            </p>
